...
// File: contracts/PolylasticTokenV3.sol

pragma solidity >=0.6.0 <0.8.0;
// SPDX-License-Identifier: None

contract PolylasticTokenV3 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Polylastic V3";
    string private constant _symbol = "POLX";
